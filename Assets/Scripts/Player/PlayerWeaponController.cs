...
//        private IEnumerator _PlayerActionCastSpellCoroutine(Magic.WandController wandController)
//        {           
...
//            {
//                equipableItemComponent = slotGameObj.GetComponent<Items.EquipableItem>(),
//                bowController = slotGameObj.GetComponent<Weapons.BowController>(), //Will be null if not a bow
//                wandControllerComponent = slotGameObj.GetComponent<Magic.WandController>(), //will be null if not a wand
...
//       //     public Items.EquipableItem equipableItemComponent;
//            public Weapons.BowController bowController; //this component will be null if equiped item is not a bow
//            public Magic.WandController wandControllerComponent; //This component will be null if equiped item is not a want
